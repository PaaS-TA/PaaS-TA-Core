...
func Initialize(logger lager.Logger, config ExecutorConfig, gardenHealthcheckRootFS string, metronClient loggregator_v2.IngressClient, clock clock.Clock) (executor.Client, grouper.Members, GardenClient.Client, error) {
	...
	if err != nil {
		...
		return nil, grouper.Members{}, nil, err
	}
