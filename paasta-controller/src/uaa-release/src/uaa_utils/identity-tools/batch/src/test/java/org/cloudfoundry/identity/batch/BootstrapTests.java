 ...
 */
package org.cloudfoundry.identity.batch;
...
public class BootstrapTests {
	...
	public void testRootContextDefaults() throws Exception {
		...
		JobController jobController = context.getBean(JobController.class);
	...
	private GenericXmlApplicationContext getServletContext(String... resources) {
		...
		factory.setResources(new Resource[] {new FileSystemResource("./src/test/resources/test/config/batch.yml")});
