  ...
  module Util
    ...
    class ConfigurationUtils
      ...
      class << self
        ...
        def load(identifier, clean_nil_values = true, should_log = true, is_packaging = false)
          ...
          if file.exist?
            ...
            if identifier.eql? 'components'
              configuration = ConfigurationUtilsForWAS.load_components_configuration(file, user_provided, should_log, is_packaging)
            else
